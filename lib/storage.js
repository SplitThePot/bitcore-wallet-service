 ...
 */
Storage.prototype.fetchNotifications = function(
  walletId,
  notificationId,
  minTs,
  cb
...
Storage.prototype.storeAddressesWithBalance = function(
  walletId,
  addresses,
  cb
) {
...
Storage.prototype.storeTxHistoryCache = function(
  walletId,
  totalItems,
  firstPosition,
  items,
...
Storage.prototype.checkAndUseBalanceCache = function(
  walletId,
  addresses,
  duration,
  cb
...
Storage.prototype.storeBalanceCache = function(
  walletId,
  addresses,
  balance,
  cb
