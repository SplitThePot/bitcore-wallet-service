...
Storage.prototype.fetchNotifications = function(walletId, notificationId, minTs, cb) {
  ...
  this.db
    ...
    .toArray(function(err, result) {
      ...
      setImmediate(() => cb(null, notifications));
    });
};
...
Storage.prototype.fetchAddressesByInfo = function(addressInfos, cb) {
  ...
  {
    $or: [{ address: 'myiguNt2q4P67kqFkj23YA2EWkFwaCM2kT', dataType: 'addresses' }];
  }
  ...
  this.db
    ...
    .toArray(function(err, result) {
      ...
      setImmediate(() => cb(null, addressResults));
    });
};
    ...
    function(err, result) {
      ...
      self.db
        ...
        .toArray(function(err, result2) {
          ...
          setImmediate(() => cb(null, addresses));
        });
    },
  );
};
